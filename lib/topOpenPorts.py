...
class TopOpenPorts:
    ...
    def topUdpAllTcp(self):
        ...
        commands = (
            ...
            f"nmap -sUV -vv --reason -T4 --max-retries 3 --max-rtt-timeout 150ms -pU:53,67-69,111,123,135,137-139,161-162,445,500,514,520,631,998,1434,1701,1900,4500,5353,5060,49152,49154 -oA {self.target}-Report/nmap/top-udp-ports {self.target}",
